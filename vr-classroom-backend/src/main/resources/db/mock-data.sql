...
-- ============================================
-- 为101教室创建座位 (10行 x 5列)
INSERT INTO seat (room_id, `row`, `col`, status, version, donor_id, claimed_at) VALUES
...
(1, 9, 4, 0, 0, NULL, NULL),
(1, 9, 5, 0, 0, NULL, NULL),
(1, 10, 1, 0, 0, NULL, NULL),
(1, 10, 2, 0, 0, NULL, NULL),
(1, 10, 3, 0, 0, NULL, NULL),
(1, 10, 4, 0, 0, NULL, NULL),
(1, 10, 5, 0, 0, NULL, NULL);
