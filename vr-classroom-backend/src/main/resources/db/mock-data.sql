...
-- ============================================
-- 10. 座位表 (seat)
-- status: 0-可购买, 1-已售出, 2-预留中
-- ============================================
-- 为101教室创建座位 (10行 x 5列)
-- price: 前3排100元, 4-6排80元, 7-10排50元
INSERT INTO seat (room_id, `row`, `col`, price, status, version, donor_id, claimed_at) VALUES
(1, 1, 1, 10000, 1, 0, 1, '2026-02-24 09:00:00'),
(1, 1, 2, 10000, 1, 0, 2, '2026-02-24 10:00:00'),
(1, 1, 3, 10000, 0, 0, NULL, NULL),
(1, 1, 4, 10000, 1, 0, 3, '2026-02-24 11:00:00'),
(1, 1, 5, 10000, 1, 0, 1, '2026-02-24 12:00:00'),
(1, 2, 1, 10000, 0, 0, NULL, NULL),
(1, 2, 2, 10000, 0, 0, NULL, NULL),
(1, 2, 3, 10000, 0, 0, NULL, NULL),
(1, 2, 4, 10000, 0, 0, NULL, NULL),
(1, 2, 5, 10000, 0, 0, NULL, NULL),
(1, 3, 1, 10000, 0, 0, NULL, NULL),
(1, 3, 2, 10000, 0, 0, NULL, NULL),
(1, 3, 3, 10000, 0, 0, NULL, NULL),
(1, 3, 4, 10000, 0, 0, NULL, NULL),
(1, 3, 5, 10000, 0, 0, NULL, NULL),
(1, 4, 1, 8000, 0, 0, NULL, NULL),
(1, 4, 2, 8000, 0, 0, NULL, NULL),
(1, 4, 3, 8000, 0, 0, NULL, NULL),
(1, 4, 4, 8000, 0, 0, NULL, NULL),
(1, 4, 5, 8000, 0, 0, NULL, NULL),
(1, 5, 1, 8000, 0, 0, NULL, NULL),
(1, 5, 2, 8000, 0, 0, NULL, NULL),
(1, 5, 3, 8000, 0, 0, NULL, NULL),
(1, 5, 4, 8000, 0, 0, NULL, NULL),
(1, 5, 5, 8000, 0, 0, NULL, NULL),
(1, 6, 1, 8000, 0, 0, NULL, NULL),
(1, 6, 2, 8000, 0, 0, NULL, NULL),
(1, 6, 3, 8000, 0, 0, NULL, NULL),
(1, 6, 4, 8000, 0, 0, NULL, NULL),
(1, 6, 5, 8000, 0, 0, NULL, NULL),
(1, 7, 1, 5000, 0, 0, NULL, NULL),
(1, 7, 2, 5000, 0, 0, NULL, NULL),
(1, 7, 3, 5000, 0, 0, NULL, NULL),
(1, 7, 4, 5000, 0, 0, NULL, NULL),
(1, 7, 5, 5000, 0, 0, NULL, NULL),
(1, 8, 1, 5000, 0, 0, NULL, NULL),
(1, 8, 2, 5000, 0, 0, NULL, NULL),
(1, 8, 3, 5000, 0, 0, NULL, NULL),
(1, 8, 4, 5000, 0, 0, NULL, NULL),
(1, 8, 5, 5000, 0, 0, NULL, NULL),
(1, 9, 1, 5000, 0, 0, NULL, NULL),
(1, 9, 2, 5000, 0, 0, NULL, NULL),
(1, 9, 3, 5000, 0, 0, NULL, NULL),
(1, 9, 4, 5000, 0, 0, NULL, NULL),
(1, 9, 5, 5000, 0, 0, NULL, NULL),
(1, 10, 1, 5000, 0, 0, NULL, NULL),
(1, 10, 2, 5000, 0, 0, NULL, NULL),
(1, 10, 3, 5000, 0, 0, NULL, NULL),
(1, 10, 4, 5000, 0, 0, NULL, NULL),
(1, 10, 5, 5000, 0, 0, NULL, NULL);
